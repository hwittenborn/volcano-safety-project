...
function angryBirdsFlyingTime() {
    var leftToRightTransition = "calc(20em + 100vw)";
    var rightToLeftTransition = "-20em";
    var birds = document.querySelectorAll(".sky-section img");
    var _loop_1 = function (iter) {
        ...
        bird.style.setProperty("margin-top", ((document.querySelector(".sky-section").clientHeight / birds.length) * iter).toString() + "px");
        ...
        bird.style.transition = "left ".concat(randomNumber(3, 8), "s ease-in-out");
    ...
    for (var iter = 0; iter < birds.length; iter++) {
        _loop_1(iter);
    }
}
...
function fancyLinks() {
    var nope_audio = new Audio("/volcano-safety-project/media/audio/nope.mp3");
    function playNope() {
        nope_audio.play();
    }
...
function smileyZoomer() {
    ...
    window.addEventListener("scroll", function () {
        if ((window.innerHeight + window.pageYOffset) >= document.body.offsetHeight) {
            ...
            setTimeout(function () {
                var smiley = document.querySelector(".remember img");
